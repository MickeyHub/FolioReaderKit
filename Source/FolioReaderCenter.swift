...
@objc public protocol FolioReaderPaginationDelegate: class {
    @objc optional func lastPaginationStandingTime(standingTime: TimeInterval)
}
...
open class FolioReaderCenter: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private var lastStandingTimestamp: Date!
    ...
    open weak var paginationDelegate: FolioReaderPaginationDelegate?
    ...
    open func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        paginationDelegate?.lastPaginationStandingTime?(standingTime: Date().timeIntervalSince(lastStandingTimestamp))
        lastStandingTimestamp = Date()
